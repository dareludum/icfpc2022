...
impl Move {
    ...
    pub fn line_cut(block: &mut Block, orientation: Orientation, offset: u32) -> Self {
        ...
        match block {
            Block::SimpleBlock(id, rect, color) => {
                let (b0, b1) = match orientation {
                    Orientation::Horizontal => {
                        ...
                        id1.push(1);
                        (
                            Block::SimpleBlock(id0, r0, *color),
                            Block::SimpleBlock(id1, r1, *color),
                        )
                    }
    ...
    pub fn point_cut(block: &mut Block, offset_x: u32, offset_y: u32) -> Self {
        ...
        match block {
            Block::SimpleBlock(id, rect, color) => {
                ...
                id1.push(3);
                let b0 = Block::SimpleBlock(id0, r0, *color);
                let b1 = Block::SimpleBlock(id1, r1, *color);
                let b2 = Block::SimpleBlock(id2, r2, *color);
                let b3 = Block::SimpleBlock(id3, r3, *color);
